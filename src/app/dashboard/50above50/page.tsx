...
const categories = [
  ...
  { id: 'photography-mobile', name: 'Mobile Photography', icon: '📲' },
  { id: 'design', name: 'Design', icon: '🧩' },
  { id: 'cooking-plating', name: 'Food Plating', icon: '🍽️' },
  { id: 'craft-jewelry', name: 'Jewelry Making', icon: '💍' },
...
export default function FiftyAboveFiftyPage() {
  ...
  const handleVote = async (submissionId: string) => {
    ...
    try {
      ...
      // Vote count is incremented by Cloud Functions; refresh to reflect it.
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                <Dialog open={isNominateOpen} onOpenChange={setNominateOpen}>
                  <DialogTrigger asChild>
                    <Button size="lg" variant="gradient" className="text-lg px-8" onClick={() => openNomination()}>
                      Nominate Now
                    ...
                    <Card key={s.id} className="border-2 overflow-hidden">
                      ...
                      <CardContent className="p-5 space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2">
                          ...
                          <Button
                            size="sm"
                            variant={votedIds[s.id] ? 'outline' : 'gradient'}
